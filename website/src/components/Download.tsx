      ...
      <div className="max-w-5xl mx-auto">
        <div className="relative rounded-3xl overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, #7B6CF6 0%, #6C5CE7 50%, #5A4BD1 100%)",
            }}
          />
          {/* Noise texture */}
          <div
          ...
          <div className="relative z-10 px-10 py-16 lg:py-20 flex flex-col lg:flex-row items-center lg:items-start gap-12">
            ...
            <div className="flex-1 text-center lg:text-left">
              <h2 className="text-4xl lg:text-5xl font-black text-white tracking-tight leading-tight mb-4">
                Ready to stop managing your Downloads?
              </h2>
              <p className="text-white/70 text-lg leading-relaxed mb-8 max-w-md">
                Download Limbo and never think about file cleanup again. Drop it
                in your system tray and walk away.
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-2xl p-7 min-w-[240px]">
              <p className="text-white/60 text-xs font-semibold uppercase tracking-wider mb-5">
                What's included
              </p>
              <ul className="space-y-3.5">
                {CHECKS.map((item) => (
                  <li
                    key={item}
                    className="flex items-center gap-3 text-white text-[14px] font-medium"
                  >
                    <CheckCircle
                      size={16}
